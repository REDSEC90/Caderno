...
## Por que o grafo vai além do SQL simples

Uma Receita que usa `ING-000001` e uma OBS sobre `ING-000001` estão conectadas indiretamente — o SQL simples precisaria de JOINs encadeados para descobrir isso. O auditor carrega o grafo completo em memória, incluindo arestas INFORMATIONAL que podem não estar na tabela `relacionamentos`, permitindo travessias que o SQL não expressa naturalmente.

---

## Próxima leitura

- Exemplos de navegação real com output → [`04-exemplos-v1.md`](04-exemplos-v1.md)
