...
- Queries prontas para copiar → [`02-consultas-comuns-v1.md`](02-consultas-comuns-v1.md)
- Navegação entre entidades relacionadas → [`03-navegacao-no-grafo-v1.md`](03-navegacao-no-grafo-v1.md)
