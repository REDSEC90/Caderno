...
## Por que o Importador nunca lê Markdown diretamente

O Importador recebe o grafo já validado — um objeto em memória limpo e verificado. Se ele lesse Markdown diretamente, precisaria reimplementar toda a lógica de parsing e validação. A separação garante que o que entra no SQLite passou por todos os guardião anteriores.
...
```
# Resultado esperado:
[OK] 13 entidades importadas — 0 erros
```
...
- Troubleshooting do Importador → [`../09-troubleshooting/04-importador-v1.md`](../09-troubleshooting/04-importador-v1.md)
- Consultas no banco após importar → [`../04-consultas/02-consultas-comuns-v1.md`](../04-consultas/02-consultas-comuns-v1.md)
